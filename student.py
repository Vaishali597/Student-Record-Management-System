...
class std():
    ...
    def addFrameFun(self):
        ...
        fLbl = tk.Label(self.addFrame, text="L_Name:",bg=self.clr(150,180,250), font=("arial",15,"bold"))
    ...
    def dbFun(self):
        self.con = pymysql.connect(host="localhost", user="root", passwd="lohar@2003", database="pymysql")
